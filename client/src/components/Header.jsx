...
const Header = () => {
    ...
    return (
        ...
        >
            <motion.div
                className='text-stone-500 inline-flex items-center gap-2 bg-rose-100 px-6 py-1 rounded-full border-2 border-neutral-500'
                initial={{ y: -20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                transition={{ delay: 0.2, duration: 0.8 }}
            >
                <p className='font-bold'>Create Stunning <span className='text-red-600 font-extrabold'>AI Art </span> from Simple Text</p>
                <img src={assets.funny} alt="" />
            </motion.div>
            ...
            >
                Convert Text into <span className='text-blue-600'>Stunning Images</span>, in seconds.
            </motion.h1>
            ...
            >
                Bring your ideas to life with AI. Simply type, and let the magic create stunning visuals in seconds.
            </motion.p>
            ...
            >
               <img className='h-6' src={assets.star_group} alt="" /> Generate Images <img className='h-6' src={assets.star_group} alt="" />
            </motion.button>
            ...
            >
                Generated images from OopsieDoodle
            </motion.p>
        </motion.div>
    )
}
...
//                 ))}
//             </div>
//             <p className='mt-2 text-neutral-600'>Generated images from OopsieDoodle</p>
//         </div>
//     )
// }
